	...
	theme: {
		...
		extend: {
			colors: {
				...
				// AI Yatra paper-and-ink palette (mirrors src/index.css vars).
				// Registered here so Tailwind generates every variant —
				// text-*, bg-*, border-*, fill-*, decoration-* incl. /opacity.
